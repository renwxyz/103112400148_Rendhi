...
### 1. Pengertian Multi Linked List (MLL)
Multi Linked List adalah struktur data non-linier yang merupakan pengembangan dari linked list, di mana setiap simpul (node) memiliki lebih dari satu pointer untuk menghubungkannya dengan simpul lain. Struktur ini digunakan untuk merepresentasikan hubungan data yang kompleks, seperti relasi satu-ke-banyak dan banyak-ke-banyak, sehingga cocok untuk memodelkan data bertingkat dan keterkaitan antar data dalam suatu sistem [3].

### 2. Relasi data
Relasi data adalah hubungan yang terbentuk antara dua atau lebih data atau entitas dalam suatu sistem, yang menunjukkan keterkaitan dan ketergantungan antar data tersebut. Relasi data digunakan untuk mengorganisasikan dan mengelola data agar tersusun secara terstruktur, sehingga memudahkan proses penyimpanan, pencarian, dan pengolahan informasi dalam sistem komputer [3].
...
Pada bagian unguided, konsep Multi Linked List dikembangkan lebih lanjut dengan studi kasus data golongan hewan dan jenis hewan, yang menekankan penerapan relasi data one-to-many. Program diuji melalui operasi pencarian berdasarkan kriteria tertentu, penghapusan node parent beserta seluruh child-nya, serta penampilan struktur MLL secara hierarkis. Hasil pengujian menunjukkan bahwa seluruh fungsi berjalan sesuai dengan perancangan dan mampu merepresentasikan relasi data secara terstruktur.

## Kesimpulan
Berdasarkan hasil praktikum Modul 13, dapat disimpulkan bahwa struktur data Multi Linked List (MLL) sangat efektif untuk merepresentasikan relasi data yang bersifat bertingkat dan kompleks. Implementasi MLL menggunakan bahasa C++ berhasil dilakukan dengan baik, ditunjukkan melalui keberhasilan operasi insert, delete, search, update, serta traversal data baik pada node parent maupun node child. Praktikum ini membantu meningkatkan pemahaman mengenai konsep relasi data, pengelolaan pointer ganda, serta penerapan struktur data non-linier dalam pemrograman. Dengan demikian, mahasiswa mampu memahami dan mengimplementasikan Multi Linked List sebagai solusi untuk permasalahan data yang memiliki hubungan satu-ke-banyak secara nyata dan terstruktur.
